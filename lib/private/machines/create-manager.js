module.exports = {
  ...
  inputs: {
    connectionString: {
      ...
      moreInfoUrl:
        "http://sailsjs.com/documentation/reference/configuration/sails-config-datastores#?the-connection-url",
    ...
    onUnexpectedFailure: {
      ...
      moreInfoUrl:
        "https://github.com/node-machine/driver-interface/blob/3f3a150ef4ece40dc0d105006e2766e81af23719/machines/create-manager.js#L37-L49",
      // example: '->',
      example: "===",
    },
  ...
  fn: async function (inputs, exits) {
    ...
    const client = new NodeMongoDBNativeLib.MongoClient(mongoUrl);
    try {
    ...
    const manager = client.db(_clientConfig.database);
